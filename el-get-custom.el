...
:username, :reponame
    ...
    \"el-get\". the `:reponame' property is only required if the
    repo name on Github differs from the Emacs package name. Note
    that `:pkgname' can also be used in place of `:reponame'.
