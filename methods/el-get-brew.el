...
(defun el-get-brew-install (package _url post-install-fun)
...
(defun el-get-brew-update (package _url post-update-fun)
  "brew update PACKAGE"
...
(defun el-get-brew-remove (package _url post-remove-fun)
